...
export default function BuyersPanel({ className = '' }: BuyersPanelProps) {
    ...
    <div className={`p-4 lg:p-6 space-y-6 ${className}`}>
      ...
      {filteredBuyers.length === 0 ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
          {filteredBuyers.map((buyer: Company) => (
            <CompanyCard 
              key={buyer.id} 
              company={buyer}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-1 text-xs bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-2 py-1 rounded-full">
