...
export default function MultiSelectSearch({
  ...
  return (
    <div className={cn("relative", className)} ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen && (
        <div className="absolute z-50 w-full mt-1 bg-white dark:bg-[#1a1a1a] border border-gray-300 dark:border-[#2a2a2a] rounded-lg shadow-lg max-h-64 overflow-hidden">
          {/* Search Input */}
